...
<head>
    ...
    <style>
        ...
        .cafe-header {
            ...
            url('<?= !empty($cafe['logo']) ? base_url('public/backend/assets/images/cafes/' . $cafe['logo']) : base_url('themes/phoenix/assets/img/restaurant-bg.jpg') ?>');
            ...
            <div class="col-md-8 text-center text-md-start">
                <div class="cafe-info">
                    <?php if (!empty($cafe['logo'])): ?>
                        <img src="<?= base_url('public/backend/assets/images/cafes/' . $cafe['logo']) ?>" alt="<?= esc($cafe['title']) ?>" class="cafe-logo">
                    <?php endif; ?>
                    ...
                    <li>
                        <a href="<?= $category['id'] ?>" class="category-box">
                            <div class="category-box-img">
                                <img class="img-fluid category-img" src="<?= base_url('public/backend/assets/images/categories/' . $category['image']['image']) ?>" alt="category">
                            </div>
                            <h5><?= esc($category['title']) ?></h5>
                        </a>
                    </li>

                <!--<a href="#category-<?php /*= $category['id'] */?>" class="category-link">
                    <?php /*if (!empty($category['image'])): */?>
                        <img src="<?php /*= base_url('public/backend/assets/images/categories/' . $category['image']['image']) */?>" alt="<?php /*= esc($category['title']) */?>" class="category-img d-block mx-auto">
                    <?php /*endif; */?>
                    <span class="d-block"><?php /*= esc($category['title']) */?></span>
                </a>-->
            <?php endforeach; ?>
                </ul>
            </section>
                            ...
                            <div class="product-card h-100">
                                <div class="overflow-hidden">
                                    <?php if (!empty($product['images'])): ?>
                                        <img src="<?= base_url('public/backend/assets/images/products/' . $product['images'][0]['image']) ?>" alt="<?= esc($product['title']) ?>" class="product-img w-100">
                                    <?php else: ?>
                                        <img src="<?= base_url('themes/phoenix/assets/img/food-placeholder.jpg') ?>" alt="Ürün resmi yok" class="product-img w-100">
                                    <?php endif; ?>
                                </div>
